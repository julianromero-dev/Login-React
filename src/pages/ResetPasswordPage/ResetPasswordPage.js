    ...
    return (
        <div className="d-flex justify-content-center align-items-center min-vh-100 bg-gradient">
            <div className="form-card">
                <h3 className="mb-4 text-center text-dark">Restablecer contraseña</h3>
                <p style={{textAlign:"center"
                }}>
                <img src="https://upload.wikimedia.org/wikipedia/commons/6/6d/InstitutoCr%C3%A9ditoOficial.svg" width={120} alt="logo ico"/>
                </p>
